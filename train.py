...
parser.add_argument('--model_name', metavar='MODEL', type=str, default='355M', help='Pretrained model name')
...
parser.add_argument('--noise', type=float, default=0.01, help='Add noise to input training data to regularize against typos.')
...
def main():
    ...
    with tf.Session() as sess:
        train_context = tf.placeholder(tf.int32, [args.batch_size, 512])
